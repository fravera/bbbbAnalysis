...
void doAllFit(std::string inputFileName)
{
    ...
    doFit(outputRootFile, theCanvasSingleMuonDouble90Quad30Ratio->cd(1),theInputFile, "SingleMuon_Double90Quad30_Efficiency_L1filterHT"                 , crystalBallAndErrorFunction, initialParameters, 100.,1500.);
    initialParameters = { 31.4358,  15.9878,  2.56566e-10,  0.976469 };
    doFit(outputRootFile, theCanvasSingleMuonDouble90Quad30Ratio->cd(2),theInputFile, "SingleMuon_Double90Quad30_Efficiency_QuadCentralJet30"           , crystalBallAndErrorFunction, initialParameters,  25., 300.);
    initialParameters = { 91.4671,  23.0038,  3.24185e-13,  0.995492 };
    doFit(outputRootFile, theCanvasSingleMuonDouble90Quad30Ratio->cd(3),theInputFile, "SingleMuon_Double90Quad30_Efficiency_DoubleCentralJet90"         , crystalBallAndErrorFunction, initialParameters,  30., 500.);
    ...
    doFit(outputRootFile, theCanvasSingleMuonDouble90Quad30Ratio->cd(5),theInputFile, "SingleMuon_Double90Quad30_Efficiency_QuadPFCentralJetLooseID30"  , crystalBallFunction, initialParameters,  25., 300.);
    initialParameters = { 92.9863,  11.7114,  0.26419,  0.734074 };
    doFit(outputRootFile, theCanvasSingleMuonDouble90Quad30Ratio->cd(6),theInputFile, "SingleMuon_Double90Quad30_Efficiency_DoublePFCentralJetLooseID90", crystalBallFunction, initialParameters,  70., 500.);
    ...
    doFit(outputRootFile, theCanvasSingleMuonQuad45Ratio->cd(1),theInputFile, "SingleMuon_Quad45_Efficiency_L1filterHT"                 , crystalBallAndErrorFunction, initialParameters, 100.,1500.);
    initialParameters = { 47.5867,  16.09,  4.26492e-12,  0.962807 };
    doFit(outputRootFile, theCanvasSingleMuonQuad45Ratio->cd(2),theInputFile, "SingleMuon_Quad45_Efficiency_QuadCentralJet45"           , crystalBallAndErrorFunction, initialParameters,  30., 300.);
    initialParameters = { 0.209598,  0.765024,  1.21809e-09,  1.05882 };
    ...
    doFit(outputRootFile, theCanvasSingleMuonQuad45Ratio->cd(4),theInputFile, "SingleMuon_Quad45_Efficiency_QuadPFCentralJetLooseID45"  , crystalBallFunction, initialParameters,  30., 300.);
    ...
    doFit(outputRootFile, theCanvasSingleMuonQuad45AfterDoubleRatio->cd(2),theInputFile, "SingleMuon_And_Efficiency_QuadCentralJet45"           , crystalBallAndErrorFunction, initialParameters,  30., 300.);
    ...
    doFit(outputRootFile, theCanvasSingleMuonQuad45AfterDoubleRatio->cd(4),theInputFile, "SingleMuon_And_Efficiency_QuadPFCentralJetLooseID45"  , crystalBallFunction, initialParameters,  30., 300.);
    ...
    initialParameters = { 240.731,  77.3069,  0.018671,  0.981187 };
    doFit(outputRootFile, theCanvasTTbarDouble90Quad30Ratio->cd(1),theInputFile, "TTbar_Double90Quad30_Efficiency_L1filterHT"                 , crystalBallAndErrorFunction, initialParameters, 100.,1500.);
    initialParameters = { 31.4358,  15.9878,  2.56566e-10,  0.976469 };
    doFit(outputRootFile, theCanvasTTbarDouble90Quad30Ratio->cd(2),theInputFile, "TTbar_Double90Quad30_Efficiency_QuadCentralJet30"           , crystalBallAndErrorFunction, initialParameters,  25., 300.);
    initialParameters = { 91.4671,  23.0038,  3.24185e-13,  0.995492 };
    doFit(outputRootFile, theCanvasTTbarDouble90Quad30Ratio->cd(3),theInputFile, "TTbar_Double90Quad30_Efficiency_DoubleCentralJet90"         , crystalBallAndErrorFunction, initialParameters,  50., 500.);
    ...
    initialParameters = { 26.7507,  12.9058,  8.91746e-08,  0.992066 };
    doFit(outputRootFile, theCanvasTTbarDouble90Quad30Ratio->cd(5),theInputFile, "TTbar_Double90Quad30_Efficiency_QuadPFCentralJetLooseID30"  , crystalBallFunction, initialParameters,  25., 300.);
    initialParameters = { 92.9863,  11.7114,  0.26419,  0.734074 };
    doFit(outputRootFile, theCanvasTTbarDouble90Quad30Ratio->cd(6),theInputFile, "TTbar_Double90Quad30_Efficiency_DoublePFCentralJetLooseID90", crystalBallFunction, initialParameters,  70., 500.);
    ...
    initialParameters = { 243.595,  84.877,  1.38778e-15,  0.997779 };
    doFit(outputRootFile, theCanvasTTbarQuad45Ratio->cd(1),theInputFile, "TTbar_Quad45_Efficiency_L1filterHT"                 , crystalBallAndErrorFunction, initialParameters, 100.,1500.);
    initialParameters = { 47.5867,  16.09,  4.26492e-12,  0.962807 };
    doFit(outputRootFile, theCanvasTTbarQuad45Ratio->cd(2),theInputFile, "TTbar_Quad45_Efficiency_QuadCentralJet45"           , crystalBallAndErrorFunction, initialParameters,  30., 300.);
    initialParameters = { 0.209598,  0.765024,  1.21809e-09,  1.05882 };
    ...
    initialParameters = { 43.2393,  12.5233,  0.074217,  0.918021 };
    doFit(outputRootFile, theCanvasTTbarQuad45Ratio->cd(4),theInputFile, "TTbar_Quad45_Efficiency_QuadPFCentralJetLooseID45"  , crystalBallFunction, initialParameters,  30., 300.);
    ...
    initialParameters = { 44.7711,  16.8627,  1.17955e-09,  0.981758 };
    doFit(outputRootFile, theCanvasTTbarQuad45AfterDoubleRatio->cd(2),theInputFile, "TTbar_And_Efficiency_QuadCentralJet45"           , crystalBallAndErrorFunction, initialParameters,  30., 300.);
    // initialParameters = { -499.291,  80,  9.53674e-07,  1 };
    ...
    initialParameters = { 43.9976,  11.5532,  0.150397,  0.847895 };
    doFit(outputRootFile, theCanvasTTbarQuad45AfterDoubleRatio->cd(4),theInputFile, "TTbar_And_Efficiency_QuadPFCentralJetLooseID45"  , crystalBallFunction, initialParameters,  30., 300.);
