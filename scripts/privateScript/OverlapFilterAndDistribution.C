...
void OverlapEfficiencyAndDistributions(TVirtualPad *theCanvas, TFile* inputFile, std::string triggerName, std::string filterName, std::string dataDataset, std::string signalDataset, std::string ttbarDataset, bool plotHistograms)
{
    ...
    if(plotHistograms) theBackgroundStack->Draw("same HIST");
    ...
    if(plotHistograms) theDataDistribution->Draw("same C E0");
    ...
    if(signalDataset != "")
    {
        ...
        if(plotHistograms) theSignalDistribution->Draw("same HIST");
    }
    ...
    if(signalDataset != "") theLegend->AddEntry(signalEff , "eff(X #rightarrow YH #rightarrow bbbb)", "epl");
    if(signalDataset != "") if(plotHistograms) theLegend->AddEntry(signalPlot, "X #rightarrow YH #rightarrow bbbb", "l");
    theLegend->Draw("same");
}
...
void OverlapAllEfficiencyAndDistributionsInFile2016(std::string inputFileName, bool plotHistograms, std::string dataDataset, std::string signalDataset, Strings... backgrounds)
{
    ...
    OverlapEfficiencyAndDistributions(theCanvasDouble90Quad30Overlap->cd(1), inputFile, triggerName, "L1filterHT"                 , dataDataset, signalDataset, backgrounds..., plotHistograms);
    // OverlapEfficiencyAndDistributions(theCanvasDouble90Quad30Overlap->cd(1), inputFile, triggerName, "L1filter"                   , dataDataset, signalDataset, backgrounds..., plotHistograms);
    OverlapEfficiencyAndDistributions(theCanvasDouble90Quad30Overlap->cd(2), inputFile, triggerName, "QuadCentralJet30"           , dataDataset, signalDataset, backgrounds..., plotHistograms);
    OverlapEfficiencyAndDistributions(theCanvasDouble90Quad30Overlap->cd(3), inputFile, triggerName, "DoubleCentralJet90"         , dataDataset, signalDataset, backgrounds..., plotHistograms);
    // OverlapEfficiencyAndDistributions(theCanvasDouble90Quad30Overlap->cd(4), inputFile, triggerName, "BTagCaloCSVp087TripleBflav" , dataDataset, signalDataset, backgrounds..., plotHistograms);
    OverlapEfficiencyAndDistributions(theCanvasDouble90Quad30Overlap->cd(4), inputFile, triggerName, "BTagCaloCSVp087Triple"      , dataDataset, signalDataset, backgrounds..., plotHistograms);
    OverlapEfficiencyAndDistributions(theCanvasDouble90Quad30Overlap->cd(5), inputFile, triggerName, "QuadPFCentralJetLooseID30"  , dataDataset, signalDataset, backgrounds..., plotHistograms);
    OverlapEfficiencyAndDistributions(theCanvasDouble90Quad30Overlap->cd(6), inputFile, triggerName, "DoublePFCentralJetLooseID90", dataDataset, signalDataset, backgrounds..., plotHistograms);
    ...
    // OverlapEfficiencyAndDistributions(theCanvasDouble90Quad30BTagOverlap->cd(1), inputFile, triggerName, "BTagCaloCSVp087Triple"                , dataDataset, signalDataset, backgrounds..., plotHistograms);
    // OverlapEfficiencyAndDistributions(theCanvasDouble90Quad30BTagOverlap->cd(2), inputFile, triggerName, "BTagCaloCSVp087TripleBflav"           , dataDataset, signalDataset, backgrounds..., plotHistograms);
    // OverlapEfficiencyAndDistributions(theCanvasDouble90Quad30BTagOverlap->cd(3), inputFile, triggerName, "BTagCaloCSVp087TripleBflav_Pt0to50"   , dataDataset, signalDataset, backgrounds..., plotHistograms);
    // OverlapEfficiencyAndDistributions(theCanvasDouble90Quad30BTagOverlap->cd(4), inputFile, triggerName, "BTagCaloCSVp087TripleBflav_Pt50to150" , dataDataset, signalDataset, backgrounds..., plotHistograms);
    // OverlapEfficiencyAndDistributions(theCanvasDouble90Quad30BTagOverlap->cd(5), inputFile, triggerName, "BTagCaloCSVp087TripleBflav_Pt150to300", dataDataset, signalDataset, backgrounds..., plotHistograms);
    // OverlapEfficiencyAndDistributions(theCanvasDouble90Quad30BTagOverlap->cd(6), inputFile, triggerName, "BTagCaloCSVp087TripleBflav_Pt300toInf", dataDataset, signalDataset, backgrounds..., plotHistograms);
    ...
    OverlapEfficiencyAndDistributions(theCanvasQuad45Overlap->cd(1), inputFile, triggerName, "L1filterHT"                , dataDataset, signalDataset, backgrounds..., plotHistograms);
    // OverlapEfficiencyAndDistributions(theCanvasQuad45Overlap->cd(1), inputFile, triggerName, "L1filter"                  , dataDataset, signalDataset, backgrounds..., plotHistograms);
    OverlapEfficiencyAndDistributions(theCanvasQuad45Overlap->cd(2), inputFile, triggerName, "QuadCentralJet45"          , dataDataset, signalDataset, backgrounds..., plotHistograms);
    // OverlapEfficiencyAndDistributions(theCanvasQuad45Overlap->cd(3), inputFile, triggerName, "BTagCaloCSVp087TripleBflav", dataDataset, signalDataset, backgrounds..., plotHistograms);
    OverlapEfficiencyAndDistributions(theCanvasQuad45Overlap->cd(3), inputFile, triggerName, "BTagCaloCSVp087Triple"     , dataDataset, signalDataset, backgrounds..., plotHistograms);
    OverlapEfficiencyAndDistributions(theCanvasQuad45Overlap->cd(4), inputFile, triggerName, "QuadPFCentralJetLooseID45" , dataDataset, signalDataset, backgrounds..., plotHistograms);
    ...
    // OverlapEfficiencyAndDistributions(theCanvasQuad45BTagOverlap->cd(1), inputFile, triggerName, "BTagCaloCSVp087Triple"                , dataDataset, signalDataset, backgrounds..., plotHistograms);
    // OverlapEfficiencyAndDistributions(theCanvasQuad45BTagOverlap->cd(2), inputFile, triggerName, "BTagCaloCSVp087TripleBflav"           , dataDataset, signalDataset, backgrounds..., plotHistograms);
    // OverlapEfficiencyAndDistributions(theCanvasQuad45BTagOverlap->cd(3), inputFile, triggerName, "BTagCaloCSVp087TripleBflav_Pt0to50"   , dataDataset, signalDataset, backgrounds..., plotHistograms);
    // OverlapEfficiencyAndDistributions(theCanvasQuad45BTagOverlap->cd(4), inputFile, triggerName, "BTagCaloCSVp087TripleBflav_Pt50to150" , dataDataset, signalDataset, backgrounds..., plotHistograms);
    // OverlapEfficiencyAndDistributions(theCanvasQuad45BTagOverlap->cd(5), inputFile, triggerName, "BTagCaloCSVp087TripleBflav_Pt150to300", dataDataset, signalDataset, backgrounds..., plotHistograms);
    // OverlapEfficiencyAndDistributions(theCanvasQuad45BTagOverlap->cd(6), inputFile, triggerName, "BTagCaloCSVp087TripleBflav_Pt300toInf", dataDataset, signalDataset, backgrounds..., plotHistograms);
    ...
    OverlapEfficiencyAndDistributions(theCanvasAndOverlap->cd(1), inputFile, triggerName, "L1filterQuad45HT"          , dataDataset, signalDataset, backgrounds..., plotHistograms);
...
void OverlapAllEfficiencyAndDistributions2016(bool plotHistograms = false)
{
    gROOT->SetBatch(true);
...
template<typename ...Strings>
void OverlapAllEfficiencyAndDistributionsInFile2017(std::string inputFileName, bool plotHistograms, std::string dataDataset, std::string signalDataset, Strings... backgrounds)
{
    TFile *inputFile = new TFile(inputFileName.data());
    ...
    OverlapEfficiencyAndDistributions(theCanvasOverlap->cd(1 ), inputFile, triggerName, "L1filterHT"                     , dataDataset, signalDataset, backgrounds..., plotHistograms);
    OverlapEfficiencyAndDistributions(theCanvasOverlap->cd(2 ), inputFile, triggerName, "QuadCentralJet30"               , dataDataset, signalDataset, backgrounds..., plotHistograms);
    OverlapEfficiencyAndDistributions(theCanvasOverlap->cd(3 ), inputFile, triggerName, "CaloQuadJet30HT300"             , dataDataset, signalDataset, backgrounds..., plotHistograms);
    OverlapEfficiencyAndDistributions(theCanvasOverlap->cd(4 ), inputFile, triggerName, "BTagCaloCSVp05Double"           , dataDataset, signalDataset, backgrounds..., plotHistograms);
    OverlapEfficiencyAndDistributions(theCanvasOverlap->cd(5 ), inputFile, triggerName, "PFCentralJetLooseIDQuad30"      , dataDataset, signalDataset, backgrounds..., plotHistograms);
    OverlapEfficiencyAndDistributions(theCanvasOverlap->cd(6 ), inputFile, triggerName, "1PFCentralJetLooseID75"         , dataDataset, signalDataset, backgrounds..., plotHistograms);
    OverlapEfficiencyAndDistributions(theCanvasOverlap->cd(7 ), inputFile, triggerName, "2PFCentralJetLooseID60"         , dataDataset, signalDataset, backgrounds..., plotHistograms);
    OverlapEfficiencyAndDistributions(theCanvasOverlap->cd(8 ), inputFile, triggerName, "3PFCentralJetLooseID45"         , dataDataset, signalDataset, backgrounds..., plotHistograms);
    OverlapEfficiencyAndDistributions(theCanvasOverlap->cd(9 ), inputFile, triggerName, "4PFCentralJetLooseID40"         , dataDataset, signalDataset, backgrounds..., plotHistograms);
    OverlapEfficiencyAndDistributions(theCanvasOverlap->cd(10), inputFile, triggerName, "PFCentralJetsLooseIDQuad30HT300", dataDataset, signalDataset, backgrounds..., plotHistograms);
    OverlapEfficiencyAndDistributions(theCanvasOverlap->cd(11), inputFile, triggerName, "BTagPFCSVp070Triple"            , dataDataset, signalDataset, backgrounds..., plotHistograms);
...
template<typename ...Strings>
void OverlapAllEfficiencyAndDistributionsInFile2018(std::string inputFileName, bool plotHistograms, std::string dataDataset, std::string signalDataset, Strings... backgrounds)
{
    TFile *inputFile = new TFile(inputFileName.data());
    ...
    OverlapEfficiencyAndDistributions(theCanvasOverlap->cd(1 ), inputFile, triggerName, "L1filterHT"                     , dataDataset, signalDataset, backgrounds..., plotHistograms);
    OverlapEfficiencyAndDistributions(theCanvasOverlap->cd(2 ), inputFile, triggerName, "QuadCentralJet30"               , dataDataset, signalDataset, backgrounds..., plotHistograms);
    OverlapEfficiencyAndDistributions(theCanvasOverlap->cd(3 ), inputFile, triggerName, "CaloQuadJet30HT320"             , dataDataset, signalDataset, backgrounds..., plotHistograms);
    OverlapEfficiencyAndDistributions(theCanvasOverlap->cd(4 ), inputFile, triggerName, "BTagCaloDeepCSVp17Double"       , dataDataset, signalDataset, backgrounds..., plotHistograms);
    OverlapEfficiencyAndDistributions(theCanvasOverlap->cd(5 ), inputFile, triggerName, "PFCentralJetLooseIDQuad30"      , dataDataset, signalDataset, backgrounds..., plotHistograms);
    OverlapEfficiencyAndDistributions(theCanvasOverlap->cd(6 ), inputFile, triggerName, "1PFCentralJetLooseID75"         , dataDataset, signalDataset, backgrounds..., plotHistograms);
    OverlapEfficiencyAndDistributions(theCanvasOverlap->cd(7 ), inputFile, triggerName, "2PFCentralJetLooseID60"         , dataDataset, signalDataset, backgrounds..., plotHistograms);
    OverlapEfficiencyAndDistributions(theCanvasOverlap->cd(8 ), inputFile, triggerName, "3PFCentralJetLooseID45"         , dataDataset, signalDataset, backgrounds..., plotHistograms);
    OverlapEfficiencyAndDistributions(theCanvasOverlap->cd(9 ), inputFile, triggerName, "4PFCentralJetLooseID40"         , dataDataset, signalDataset, backgrounds..., plotHistograms);
    OverlapEfficiencyAndDistributions(theCanvasOverlap->cd(10), inputFile, triggerName, "PFCentralJetsLooseIDQuad30HT330", dataDataset, signalDataset, backgrounds..., plotHistograms);
    OverlapEfficiencyAndDistributions(theCanvasOverlap->cd(11), inputFile, triggerName, "BTagPFDeepCSV4p5Triple"         , dataDataset, signalDataset, backgrounds..., plotHistograms);
    theCanvasOverlap->SaveAs((std::string(inputFileName.substr(0,inputFileName.length()-5) + "_" + theCanvasOverlap->GetName()) + ".png").data());
    delete theCanvasOverlap;
