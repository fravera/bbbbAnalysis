...
void OverlapAll()
{
    ...
    // OverlapFile<>("TriggerEfficiency_SingleMuon_oldTriggerUnMatched_IsoMu24.root","IsoMu24",kBlue,"TriggerEfficiency_SingleMuon_oldTriggerUnMatched_IsoMu24_Matched.root","IsoMu24_Matched",kRed,"TriggerEfficiency_SingleMuon_oldTriggerUnMatched_IsoMu20.root","IsoMu20",kGreen,"TriggerEfficiency_SingleMuon_oldTriggerUnMatched_IsoMu20_Matched.root","IsoMu20_Matched",kOrange,"OverlapTriggerEfficiency_SingleMuon_oldTriggerUnMatched.root");
