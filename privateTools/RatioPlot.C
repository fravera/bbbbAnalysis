...
void RatioTriggerClosure()
{
    ...
    auto makeTriggerVariationNames = [](std::string variableName) -> std::vector<string>
    {
        return {"/ttBarNotTriggered/notTriggeredSelectionScaled_Full/ttBarNotTriggered_notTriggeredSelectionScaled_Full_" + variableName                             ,
                "/ttBarNotTriggered/notTriggeredSelectionScaled_Full/ttBarNotTriggered_notTriggeredSelectionScaled_Full_" + variableName + "_triggerMcEfficiencyUp"  ,
                "/ttBarNotTriggered/notTriggeredSelectionScaled_Full/ttBarNotTriggered_notTriggeredSelectionScaled_Full_" + variableName + "_triggerMcEfficiencyDown"};
    };
    
    TCanvas *theCanvasTriggerClosureTTbar = new TCanvas("TriggerClosureTTbar", "TriggerClosureTTbar", 1400, 800);
    theCanvasTriggerClosureTTbar->DivideSquare(12,0.005,0.005);
    ...
    RatioPlotFromFile(theCanvasTriggerClosureTTbar->cd(1 ),"2016DataPlots_NMSSM_XYH_bbbb_triggerClosure_triggered/outPlotter.root", "ttBarTriggered/triggeredMatchedSelection_Full/ttBarTriggered_triggeredMatchedSelection_Full_FirstJetPt"      , inputFileNameList, makeTriggerVariationNames("FirstJetPt"      ), histogramColorList, false, -1, 0.   , 600., 1, "p_{T} [GeV]", "entries [a.u.]");
    RatioPlotFromFile(theCanvasTriggerClosureTTbar->cd(2 ),"2016DataPlots_NMSSM_XYH_bbbb_triggerClosure_triggered/outPlotter.root", "ttBarTriggered/triggeredMatchedSelection_Full/ttBarTriggered_triggeredMatchedSelection_Full_SecondJetPt"     , inputFileNameList, makeTriggerVariationNames("SecondJetPt"     ), histogramColorList, false, -1, 0.   , 400., 1, "p_{T} [GeV]", "entries [a.u.]");
    RatioPlotFromFile(theCanvasTriggerClosureTTbar->cd(3 ),"2016DataPlots_NMSSM_XYH_bbbb_triggerClosure_triggered/outPlotter.root", "ttBarTriggered/triggeredMatchedSelection_Full/ttBarTriggered_triggeredMatchedSelection_Full_ThirdJetPt"      , inputFileNameList, makeTriggerVariationNames("ThirdJetPt"      ), histogramColorList, false, -1, 0.   , 250., 1, "p_{T} [GeV]", "entries [a.u.]");
    RatioPlotFromFile(theCanvasTriggerClosureTTbar->cd(4 ),"2016DataPlots_NMSSM_XYH_bbbb_triggerClosure_triggered/outPlotter.root", "ttBarTriggered/triggeredMatchedSelection_Full/ttBarTriggered_triggeredMatchedSelection_Full_FourthJetPt"     , inputFileNameList, makeTriggerVariationNames("FourthJetPt"     ), histogramColorList, false, -1, 0.   , 200., 1, "p_{T} [GeV]", "entries [a.u.]");
    RatioPlotFromFile(theCanvasTriggerClosureTTbar->cd(5 ),"2016DataPlots_NMSSM_XYH_bbbb_triggerClosure_triggered/outPlotter.root", "ttBarTriggered/triggeredMatchedSelection_Full/ttBarTriggered_triggeredMatchedSelection_Full_FirstJetEta"     , inputFileNameList, makeTriggerVariationNames("FirstJetEta"     ), histogramColorList, false, -1, -2.5 , 2.5 , 1, "eta"        , "entries [a.u.]");
    RatioPlotFromFile(theCanvasTriggerClosureTTbar->cd(6 ),"2016DataPlots_NMSSM_XYH_bbbb_triggerClosure_triggered/outPlotter.root", "ttBarTriggered/triggeredMatchedSelection_Full/ttBarTriggered_triggeredMatchedSelection_Full_SecondJetEta"    , inputFileNameList, makeTriggerVariationNames("SecondJetEta"    ), histogramColorList, false, -1, -2.5 , 2.5 , 1, "eta"        , "entries [a.u.]");
    RatioPlotFromFile(theCanvasTriggerClosureTTbar->cd(7 ),"2016DataPlots_NMSSM_XYH_bbbb_triggerClosure_triggered/outPlotter.root", "ttBarTriggered/triggeredMatchedSelection_Full/ttBarTriggered_triggeredMatchedSelection_Full_ThirdJetEta"     , inputFileNameList, makeTriggerVariationNames("ThirdJetEta"     ), histogramColorList, false, -1, -2.5 , 2.5 , 1, "eta"        , "entries [a.u.]");
    RatioPlotFromFile(theCanvasTriggerClosureTTbar->cd(8 ),"2016DataPlots_NMSSM_XYH_bbbb_triggerClosure_triggered/outPlotter.root", "ttBarTriggered/triggeredMatchedSelection_Full/ttBarTriggered_triggeredMatchedSelection_Full_FourthJetEta"    , inputFileNameList, makeTriggerVariationNames("FourthJetEta"    ), histogramColorList, false, -1, -2.5 , 2.5 , 1, "eta"        , "entries [a.u.]");
    RatioPlotFromFile(theCanvasTriggerClosureTTbar->cd(9 ),"2016DataPlots_NMSSM_XYH_bbbb_triggerClosure_triggered/outPlotter.root", "ttBarTriggered/triggeredMatchedSelection_Full/ttBarTriggered_triggeredMatchedSelection_Full_FirstJetDeepCSV" , inputFileNameList, makeTriggerVariationNames("FirstJetDeepCSV" ), histogramColorList, false, -1, 0.   , 1.  , 1, "deepFlav"   , "entries [a.u.]");
    RatioPlotFromFile(theCanvasTriggerClosureTTbar->cd(10),"2016DataPlots_NMSSM_XYH_bbbb_triggerClosure_triggered/outPlotter.root", "ttBarTriggered/triggeredMatchedSelection_Full/ttBarTriggered_triggeredMatchedSelection_Full_SecondJetDeepCSV", inputFileNameList, makeTriggerVariationNames("SecondJetDeepCSV"), histogramColorList, false, -1, 0.   , 1.  , 1, "deepFlav"   , "entries [a.u.]");
    RatioPlotFromFile(theCanvasTriggerClosureTTbar->cd(11),"2016DataPlots_NMSSM_XYH_bbbb_triggerClosure_triggered/outPlotter.root", "ttBarTriggered/triggeredMatchedSelection_Full/ttBarTriggered_triggeredMatchedSelection_Full_ThirdJetDeepCSV" , inputFileNameList, makeTriggerVariationNames("ThirdJetDeepCSV" ), histogramColorList, false, -1, 0.   , 1.  , 1, "deepFlav"   , "entries [a.u.]");
    RatioPlotFromFile(theCanvasTriggerClosureTTbar->cd(12),"2016DataPlots_NMSSM_XYH_bbbb_triggerClosure_triggered/outPlotter.root", "ttBarTriggered/triggeredMatchedSelection_Full/ttBarTriggered_triggeredMatchedSelection_Full_FourthJetDeepCSV", inputFileNameList, makeTriggerVariationNames("FourthJetDeepCSV"), histogramColorList, false, -1, 0.   , 1.  , 1, "deepFlav"   , "entries [a.u.]");
    theCanvasTriggerClosureTTbar->SaveAs((std::string(theCanvasTriggerClosureTTbar->GetName()) + ".png").data());
}
