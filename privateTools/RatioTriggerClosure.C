...
void RatioTriggerClosure(std::string inputFileName, int year)
{
    ...
    {
        RatioPlotFromFileVariation(theCanvasTriggerClosureNMSSMSignalRegion2->cd(1),inputFileName, "sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "/PtAndEtaBaseCuts_SignalRegion/sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "_PtAndEtaBaseCuts_SignalRegion_HLT_SumPtCaloJet"          , inputFileName, makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_SumPtCaloJet"          , "SignalRegion")[0],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_SumPtCaloJet"          , "SignalRegion")[1],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_SumPtCaloJet"          , "SignalRegion")[2],  0. , 1000. , 1, "Sum p_{T} eta restricted [GeV]", "entries [a.u.]");
        RatioPlotFromFileVariation(theCanvasTriggerClosureNMSSMSignalRegion2->cd(2),inputFileName, "sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "/PtAndEtaBaseCuts_SignalRegion/sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "_PtAndEtaBaseCuts_SignalRegion_HLT_SumPtPfJet"            , inputFileName, makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_SumPtPfJet"            , "SignalRegion")[0],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_SumPtPfJet"            , "SignalRegion")[1],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_SumPtPfJet"            , "SignalRegion")[2],  0. , 1000. , 1, "Sum p_{T}^{2} [GeV]"           , "entries [a.u.]");
