...
//         if(dataset == "sig_NMSSM_bbbb_MX_300_MY_60_") notTriggeredString = "notTriggered";
...
//     int year = 2016;
//     TCanvas *theCanvasTriggerClosureNMSSMSignalRegion2 = new TCanvas(("TriggerClosureNMSSMSignalRegion2" + datasetAppend).data(), ("TriggerClosureNMSSMSignalRegion2" + datasetAppend).data(), 1400, 1000);
//     theCanvasTriggerClosureNMSSMSignalRegion2->DivideSquare(6,0.005,0.005);
//     RatioPlotFromFileVariation(theCanvasTriggerClosureNMSSMSignalRegion2->cd(4),inputFileName, "sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "/PtAndEtaBaseCuts_SignalRegion/sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "_PtAndEtaBaseCuts_SignalRegion_H1_m"            , inputFileName, makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "H1_m"            , "SignalRegion")[0],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "H1_m"            , "SignalRegion")[1],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "H1_m"            , "SignalRegion")[2], 90.  , 160. , 4, "m_{Hreco} [GeV]"    , "entries [a.u.]");
//     RatioPlotFromFileVariation(theCanvasTriggerClosureNMSSMSignalRegion2->cd(5),inputFileName, "sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "/PtAndEtaBaseCuts_SignalRegion/sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "_PtAndEtaBaseCuts_SignalRegion_H2_m"            , inputFileName, makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "H2_m"            , "SignalRegion")[0],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "H2_m"            , "SignalRegion")[1],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "H2_m"            , "SignalRegion")[2], 0.   , 800. , 4, "m_{Yreco} [GeV]"    , "entries [a.u.]");
//     RatioPlotFromFileVariation(theCanvasTriggerClosureNMSSMSignalRegion2->cd(6),inputFileName, "sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "/PtAndEtaBaseCuts_SignalRegion/sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "_PtAndEtaBaseCuts_SignalRegion_HH_m"            , inputFileName, makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HH_m"            , "SignalRegion")[0],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HH_m"            , "SignalRegion")[1],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HH_m"            , "SignalRegion")[2], 200. , 1200., 4, "m_{Xreco} [GeV]"    , "entries [a.u.]");
...
void RatioTriggerClosure(std::string inputFileName, int year)
{
    ...
    {
        RatioPlotFromFileVariation(theCanvasTriggerClosureTTbarSignalRegion2->cd(1),inputFileName, "ttBarTriggered" + datasetAppend + "/PtAndEtaBaseCuts_SignalRegion/ttBarTriggered" + datasetAppend + "_PtAndEtaBaseCuts_SignalRegion_HLT_allJetAbove30Eta24_sum", inputFileName, makeTriggerVariationNames("ttBar", "HLT_allJetAbove30Eta24_sum", "SignalRegion")[0],makeTriggerVariationNames("ttBar", "HLT_allJetAbove30Eta24_sum", "SignalRegion")[1],makeTriggerVariationNames("ttBar", "HLT_allJetAbove30Eta24_sum", "SignalRegion")[2],  0. , 1000. , 1, "Sum p_{T} eta restricted [GeV]", "entries [a.u.]");
        RatioPlotFromFileVariation(theCanvasTriggerClosureTTbarSignalRegion2->cd(2),inputFileName, "ttBarTriggered" + datasetAppend + "/PtAndEtaBaseCuts_SignalRegion/ttBarTriggered" + datasetAppend + "_PtAndEtaBaseCuts_SignalRegion_HLT_SumPtAbove30"          , inputFileName, makeTriggerVariationNames("ttBar", "HLT_SumPtAbove30"          , "SignalRegion")[0],makeTriggerVariationNames("ttBar", "HLT_SumPtAbove30"          , "SignalRegion")[1],makeTriggerVariationNames("ttBar", "HLT_SumPtAbove30"          , "SignalRegion")[2],  0. , 1000. , 1, "Sum p_{T}^{2} [GeV]"           , "entries [a.u.]");
    ...
    if(year==2016)
    {
        RatioPlotFromFileVariation(theCanvasTriggerClosureNMSSMSignalRegion2->cd(1),inputFileName, "sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "/PtAndEtaBaseCuts_SignalRegion/sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "_PtAndEtaBaseCuts_SignalRegion_HLT_SumPt"          , inputFileName, makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_SumPt"          , "SignalRegion")[0],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_SumPt"          , "SignalRegion")[1],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_SumPt"          , "SignalRegion")[2],  0. , 1000. , 1, "Sum p_{T}^{2} [GeV]", "entries [a.u.]");
        RatioPlotFromFileVariation(theCanvasTriggerClosureNMSSMSignalRegion2->cd(2),inputFileName, "sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "/PtAndEtaBaseCuts_SignalRegion/sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "_PtAndEtaBaseCuts_SignalRegion_HLT_Pt2"            , inputFileName, makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_Pt2"            , "SignalRegion")[0],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_Pt2"            , "SignalRegion")[1],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_Pt2"            , "SignalRegion")[2],  0. ,  500. , 1, "p_{T}^{2} [GeV]"    , "entries [a.u.]");
        RatioPlotFromFileVariation(theCanvasTriggerClosureNMSSMSignalRegion2->cd(3),inputFileName, "sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "/PtAndEtaBaseCuts_SignalRegion/sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "_PtAndEtaBaseCuts_SignalRegion_HLT_Pt4"            , inputFileName, makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_Pt4"            , "SignalRegion")[0],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_Pt4"            , "SignalRegion")[1],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_Pt4"            , "SignalRegion")[2],  0. ,  300. , 1, "p_{T}^{4} [GeV]"    , "entries [a.u.]");
    }
    else
    {
        RatioPlotFromFileVariation(theCanvasTriggerClosureNMSSMSignalRegion2->cd(1),inputFileName, "sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "/PtAndEtaBaseCuts_SignalRegion/sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "_PtAndEtaBaseCuts_SignalRegion_HLT_allJetAbove30Eta24_sum", inputFileName, makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_allJetAbove30Eta24_sum", "SignalRegion")[0],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_allJetAbove30Eta24_sum", "SignalRegion")[1],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_allJetAbove30Eta24_sum", "SignalRegion")[2],  0. , 1000. , 1, "Sum p_{T} eta restricted [GeV]", "entries [a.u.]");
        RatioPlotFromFileVariation(theCanvasTriggerClosureNMSSMSignalRegion2->cd(2),inputFileName, "sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "/PtAndEtaBaseCuts_SignalRegion/sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "_PtAndEtaBaseCuts_SignalRegion_HLT_SumPtAbove30"          , inputFileName, makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_SumPtAbove30"          , "SignalRegion")[0],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_SumPtAbove30"          , "SignalRegion")[1],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_SumPtAbove30"          , "SignalRegion")[2],  0. , 1000. , 1, "Sum p_{T}^{2} [GeV]"           , "entries [a.u.]");
        RatioPlotFromFileVariation(theCanvasTriggerClosureNMSSMSignalRegion2->cd(3),inputFileName, "sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "/PtAndEtaBaseCuts_SignalRegion/sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "_PtAndEtaBaseCuts_SignalRegion_HLT_Pt1"                   , inputFileName, makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_Pt1"                   , "SignalRegion")[0],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_Pt1"                   , "SignalRegion")[1],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_Pt1"                   , "SignalRegion")[2],  0. ,  500. , 1, "p_{T}^{1} [GeV]"               , "entries [a.u.]");
        RatioPlotFromFileVariation(theCanvasTriggerClosureNMSSMSignalRegion2->cd(4),inputFileName, "sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "/PtAndEtaBaseCuts_SignalRegion/sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "_PtAndEtaBaseCuts_SignalRegion_HLT_Pt2"                   , inputFileName, makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_Pt2"                   , "SignalRegion")[0],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_Pt2"                   , "SignalRegion")[1],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_Pt2"                   , "SignalRegion")[2],  0. ,  500. , 1, "p_{T}^{2} [GeV]"               , "entries [a.u.]");
        RatioPlotFromFileVariation(theCanvasTriggerClosureNMSSMSignalRegion2->cd(5),inputFileName, "sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "/PtAndEtaBaseCuts_SignalRegion/sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "_PtAndEtaBaseCuts_SignalRegion_HLT_Pt3"                   , inputFileName, makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_Pt3"                   , "SignalRegion")[0],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_Pt3"                   , "SignalRegion")[1],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_Pt3"                   , "SignalRegion")[2],  0. ,  500. , 1, "p_{T}^{3} [GeV]"               , "entries [a.u.]");
        RatioPlotFromFileVariation(theCanvasTriggerClosureNMSSMSignalRegion2->cd(6),inputFileName, "sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "/PtAndEtaBaseCuts_SignalRegion/sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "_PtAndEtaBaseCuts_SignalRegion_HLT_Pt4"                   , inputFileName, makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_Pt4"                   , "SignalRegion")[0],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_Pt4"                   , "SignalRegion")[1],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HLT_Pt4"                   , "SignalRegion")[2],  0. ,  300. , 1, "p_{T}^{4} [GeV]"               , "entries [a.u.]");
    }
    RatioPlotFromFileVariation(theCanvasTriggerClosureNMSSMSignalRegion2->cd(numberOfCanvas-2),inputFileName, "sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "/PtAndEtaBaseCuts_SignalRegion/sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "_PtAndEtaBaseCuts_SignalRegion_H1_m"            , inputFileName, makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "H1_m"            , "SignalRegion")[0],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "H1_m"            , "SignalRegion")[1],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "H1_m"            , "SignalRegion")[2], 90.  , 160. , 4, "m_{Hreco} [GeV]"    , "entries [a.u.]");
    RatioPlotFromFileVariation(theCanvasTriggerClosureNMSSMSignalRegion2->cd(numberOfCanvas-1),inputFileName, "sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "/PtAndEtaBaseCuts_SignalRegion/sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "_PtAndEtaBaseCuts_SignalRegion_H2_m"            , inputFileName, makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "H2_m"            , "SignalRegion")[0],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "H2_m"            , "SignalRegion")[1],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "H2_m"            , "SignalRegion")[2], 0.   , 800. , 4, "m_{Yreco} [GeV]"    , "entries [a.u.]");
    RatioPlotFromFileVariation(theCanvasTriggerClosureNMSSMSignalRegion2->cd(numberOfCanvas  ),inputFileName, "sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "/PtAndEtaBaseCuts_SignalRegion/sig_NMSSM_bbbb_MX_300_MY_60_triggered" + datasetAppend + "_PtAndEtaBaseCuts_SignalRegion_HH_m"            , inputFileName, makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HH_m"            , "SignalRegion")[0],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HH_m"            , "SignalRegion")[1],makeTriggerVariationNames("sig_NMSSM_bbbb_MX_300_MY_60_", "HH_m"            , "SignalRegion")[2], 200. , 1200., 4, "m_{Xreco} [GeV]"    , "entries [a.u.]");
    theCanvasTriggerClosureNMSSMSignalRegion2->SaveAs((std::string(theCanvasTriggerClosureNMSSMSignalRegion2->GetName()) + "_" + std::to_string(year) + ".png").data());
    ...
    {
        RatioPlotFromFileVariation(theCanvasTriggerClosureSingleMuonSignalRegion2->cd(1),inputFileName, "singleMuonTriggered" + datasetAppend + "/PtAndEtaBaseCuts_SignalRegion/singleMuonTriggered" + datasetAppend + "_PtAndEtaBaseCuts_SignalRegion_HLT_allJetAbove30Eta24_sum", inputFileName, makeTriggerVariationNames("singleMuon", "HLT_allJetAbove30Eta24_sum", "SignalRegion")[0],makeTriggerVariationNames("singleMuon", "HLT_allJetAbove30Eta24_sum", "SignalRegion")[1],makeTriggerVariationNames("singleMuon", "HLT_allJetAbove30Eta24_sum", "SignalRegion")[2],  0. , 1000. , 1, "Sum p_{T} eta restricted [GeV]", "entries [a.u.]");
        RatioPlotFromFileVariation(theCanvasTriggerClosureSingleMuonSignalRegion2->cd(2),inputFileName, "singleMuonTriggered" + datasetAppend + "/PtAndEtaBaseCuts_SignalRegion/singleMuonTriggered" + datasetAppend + "_PtAndEtaBaseCuts_SignalRegion_HLT_SumPtAbove30"          , inputFileName, makeTriggerVariationNames("singleMuon", "HLT_SumPtAbove30"          , "SignalRegion")[0],makeTriggerVariationNames("singleMuon", "HLT_SumPtAbove30"          , "SignalRegion")[1],makeTriggerVariationNames("singleMuon", "HLT_SumPtAbove30"          , "SignalRegion")[2],  0. , 1000. , 1, "Sum p_{T}^{2} [GeV]"           , "entries [a.u.]");
...
void RatioAllTriggerClosure()
{
    RatioTriggerClosure("2016DataPlots_NMSSM_XYH_bbbb_triggerClosure/outPlotter.root", 2016);
    // RatioTriggerClosure("2017DataPlots_NMSSM_XYH_bbbb_triggerClosure/outPlotter.root", 2017);
    RatioTriggerClosure("2018DataPlots_NMSSM_XYH_bbbb_triggerClosure/outPlotter.root", 2018);
}