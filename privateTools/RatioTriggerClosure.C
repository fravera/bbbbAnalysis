...
void RatioTriggerClosure2017(std::string inputFileName, int year)
{
...
void RatioAllTriggerClosure2017()
{
    RatioTriggerClosure2017("2017DataPlots_NMSSM_XYH_bbbb_triggerClosure/outPlotter.root", 2017);
    RatioTriggerClosure2017("2018DataPlots_NMSSM_XYH_bbbb_triggerClosure/outPlotter.root", 2018);
}